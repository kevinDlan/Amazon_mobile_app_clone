        ...
        child: Column(
          ...
          children: [
                ...
                items: widget.product.images.map((e) {
                  return Builder(
                      builder: (BuildContext context) =>
                          Image.network(e, fit: BoxFit.contain, height: 60));
                }).toList(),
            ...
            Padding(
              ...
              child: CustomButton(value: "Buy Now", onTap: () {}),
            ),
            ...
            RatingBar.builder(
              ...
              return const Icon(Icons.star, size: 10, color: GlobalVariables.secondaryColor,);
            }, onRatingUpdate: (rating)
            {
                productDetailsService.rateProduct(context, widget.product, rating);
            })
          ],
        ),
      ),
